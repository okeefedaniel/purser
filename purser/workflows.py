...
SUBMISSION_WORKFLOW = WorkflowEngine(
    ...
    Transition(
        'draft', 'submitted',
        roles=['purser_submitter', 'purser_admin', 'agency_admin'],
        label='Submit',
        description='Submit monthly report for review',
    ),
    Transition(
        'submitted', 'under_review',
        roles=['purser_reviewer', 'purser_admin', 'agency_admin'],
        label='Begin Review',
    ),
    Transition(
    ...
    Transition(
        'approved', 'closed',
        roles=['purser_admin', 'agency_admin'],
        label='Close',
    ),
    ],
...
COMPLIANCE_WORKFLOW = WorkflowEngine([
    ...
    Transition(
        'pending', 'submitted',
        roles=['external_submitter', 'purser_submitter', 'purser_admin', 'agency_admin'],
        label='Submit',
    ),
    Transition(
        'overdue', 'submitted',
    ...
    Transition(
        'submitted', 'under_review',
        roles=['purser_compliance_officer', 'purser_admin', 'agency_admin'],
        label='Review',
    ),
    Transition(
